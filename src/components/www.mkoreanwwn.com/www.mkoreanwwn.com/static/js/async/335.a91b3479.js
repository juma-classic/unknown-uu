...
`;
      ...
      let n = [],
        r = () => [[(0, i.NC)("Select option"), ""]],
        s = (e) => encodeURIComponent(JSON.stringify(e ?? [])),
        c = (e) => {
          try {
        ...
        u = (e) =>
          e
            ? (!e.__deriv_option_variable_options__ &&
                (e.__deriv_option_variable_options__ = Object.create(null)),
              e.__deriv_option_variable_options__)
            : null,
        d = (e, t) => {
          let o = u(e),
        ...
        p = (e, t, o) => {
          let i = u(e);
          i && t && (i[t] = Array.isArray(o) ? [...o] : []);
        };
      (window.Blockly.Blocks.variables_set_option = {
        init() {
          (this.options_ = [...n]),
            this.jsonInit(this.definition()),
            this.loadOptionsFromStore_();
        },
        definition() {
          return {
            message0: (0, i.NC)("set {{ variable }} to {{ option }}", {
              variable: "%1",
              option: "%2",
            }),
            args0: [
            ...
            nextStatement: null,
            tooltip: (0, i.NC)(
              "Sets a variable to a selected dropdown option."
            ),
            category: window.Blockly.Categories.Variables,
          };
        },
        meta: () => ({
          display_name: (0, i.NC)("Set variable (options)"),
          description: (0, i.NC)(
            "Assigns a selected dropdown option to a variable."
          ),
        }),
        customContextMenu(e) {
          (0, a.Z3)(e);
        },
        loadOptionsFromStore_() {
          var e;
          let t = this.workspace,
            o =
              null === (e = this.getFieldValue) || void 0 === e
                ? void 0
                : e.call(this, "VAR");
          t && o && (this.options_ = d(t, o));
        },
        getOptionMenu_() {
          var e, t, o;
          let i =
              Array.isArray(this.options_) && this.options_.length
                ? this.options_
                : r(),
            a =
              null === (o = this.getField) || void 0 === o
                ? void 0
                : null === (t = o.call(this, "OPTION")) || void 0 === t
                ? void 0
                : null === (e = t.getValue) || void 0 === e
                ? void 0
                : e.call(t),
            l = new Set(
              i.map((e) => {
          ...
          return a && "" !== a && !l.has(a) ? [[a, a], ...i] : i;
        },
        syncOptionsToPeers_() {
          let e = this.workspace;
          if (!e) return;
          let t = this.getFieldValue("VAR");
          if (!!t)
            p(e, t, this.options_),
              e
                .getAllBlocks(!1)
                .filter((e) => {
                  var o;
                  return (
                    ("variables_set_option" === e.type ||
                      "variables_is_option" === e.type) &&
                    (null === (o = e.getFieldValue) || void 0 === o
                      ? void 0
                      : o.call(e, "VAR")) === t
                  );
                })
                .forEach((e) => {
                  var t, o, i;
                  e.options_ = [...this.options_];
                  let a =
                    null === (t = e.getField) || void 0 === t
                      ? void 0
                      : t.call(e, "OPTION");
                  if (a) {
                    let t = a.getValue(),
        ...
        mutationToDom() {
          let e = document.createElement("mutation");
          return e.setAttribute("options", s(this.options_)), e;
        },
        domToMutation(e) {
          var t;
          let o = c(e.getAttribute("options"));
          this.options_ = o;
          let i = this.workspace;
          p(
            i,
            null === (t = this.getFieldValue) || void 0 === t
              ? void 0
              : t.call(this, "VAR"),
            this.options_
          );
        ...
        onchange(e) {
          if (
            ...
            e &&
              ...
              e.blockId === this.id &&
              "VAR" === e.name &&
              (this.loadOptionsFromStore_(), this.syncOptionsToPeers_());
        },
      }),
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.variables_set_option =
          (e) => {
            let t = window.Blockly.JavaScript.variableDB_.getName(
                e.getFieldValue("VAR"),
                window.Blockly.Variables.CATEGORY_NAME
              ),
              o = e.getFieldValue("OPTION");
            return `${t} = ${JSON.stringify(o)};
`;
          });
      let y = "__ADD_OPTION__",
        w = "__EDIT_OPTION__",
        k = "__DELETE_OPTION__",
        B = [],
        _ = () => [[(0, i.NC)("Select option"), ""]],
        h = (e) => encodeURIComponent(JSON.stringify(e ?? [])),
        m = (e) => {
          try {
            let t = JSON.parse(decodeURIComponent(e || ""));
            return Array.isArray(t) ? t : [];
      ...
      (window.Blockly.Blocks.variables_is_option = {
        ...
        definition() {
          return {
            message0: (0, i.NC)("{{ variable }} is {{ option }}", {
              variable: "%1",
              option: "%2",
            }),
            args0: [
            ...
            colourTertiary: window.Blockly.Colours.Base.colourTertiary,
            tooltip: (0, i.NC)(
              "Returns TRUE if the variable equals the selected option."
            ),
            category: window.Blockly.Categories.Variables,
          };
        },
        meta: () => ({
          display_name: (0, i.NC)("User-defined variable is option"),
          description: (0, i.NC)(
            "Returns TRUE if the variable equals the selected option."
          ),
        }),
        customContextMenu(e) {
          ...
          (0, a.Z3)(e);
          let n =
            null === (l = this.getField) || void 0 === l
              ? void 0
              : null === (o = l.call(this, "OPTION")) || void 0 === o
              ? void 0
          ...
          n &&
            ...
            n !== k &&
            "" !== n &&
            Array.isArray(this.options_) &&
            this.options_.some((e) => {
              let [, t] = e;
              return t === n;
            }) &&
            (e.push({
              text: (0, i.NC)("✏️ Edit option"),
              callback: () => this.editOption_(),
            }),
            e.push({
              text: (0, i.NC)("\uD83D\uDDD1️ Delete option"),
              callback: () => this.removeOption_(),
            }));
        },
        loadOptionsFromStore_() {
          var e;
          let t = this.workspace,
            o =
              null === (e = this.getFieldValue) || void 0 === e
                ? void 0
                : e.call(this, "VAR");
          t && o && (this.options_ = g(t, o));
        },
        getOptionMenu_() {
          var e, t, o;
          (!Array.isArray(this.options_) || 0 === this.options_.length) &&
            this.loadOptionsFromStore_();
          let a =
              Array.isArray(this.options_) && this.options_.length
                ? this.options_
          ...
          return s.push([(0, i.NC)("➕ Add new option"), y]), s;
        },
        addOption_() {
          var e;
          let t = window.prompt(
            (0, i.NC)("Enter option label"),
            (0, i.NC)("New option")
          );
          if (!t) return;
          let o = String(t).trim();
          if (!o) return;
          let a = T(this.options_, o);
          this.options_ = [...(this.options_ ?? []), [o, a]];
          let l = this.workspace,
            n = this.getFieldValue("VAR");
          if ((C(l, n, this.options_), l && n)) {
            let e = l.getAllBlocks(!1).find((e) => {
              var t;
              return (
                "variables_set_option" === e.type &&
                (null === (t = e.getFieldValue) || void 0 === t
                  ? void 0
                  : t.call(e, "VAR")) === n
              );
            });
            (null == e ? void 0 : e.syncOptionsToPeers_) &&
              ((e.options_ = [...this.options_]), e.syncOptionsToPeers_());
          }
          null === (e = this.getField("OPTION")) ||
            void 0 === e ||
            e.setValue(a);
        },
        removeOption_() {
          ...
          let c =
            null ===
              (a = this.options_.find((e) => {
                let [, t] = e;
                return t === s;
              })) || void 0 === a
              ? void 0
              : a[0];
          if (!c || !window.confirm((0, i.NC)(`Remove option "${c}"?`))) return;
          this.options_ = this.options_.filter((e) => {
            let [, t] = e;
            return t !== s;
          });
          let u = this.workspace,
            d = this.getFieldValue("VAR");
          if ((C(u, d, this.options_), u && d)) {
            let e = u.getAllBlocks(!1).find((e) => {
              var t;
              return (
                "variables_set_option" === e.type &&
                (null === (t = e.getFieldValue) || void 0 === t
          ...
          null === (r = this.getField("OPTION")) ||
            void 0 === r ||
            r.setValue(
              ((null === (n = this.options_) || void 0 === n
                ? void 0
                : null === (l = n[0]) || void 0 === l
                ? void 0
                : l[1]) ??
        ...
        editOption_() {
          ...
          let l =
            null === (o = this.getField) || void 0 === o
              ...
              : e.call(t);
          if (!l || l === y || "" === l) return;
          let n = this.options_.find((e) => {
            let [, t] = e;
            return t === l;
          });
          if (!n) return;
          let [r] = n,
            s = window.prompt((0, i.NC)("Edit option label"), r);
          if (!s) return;
          let c = String(s).trim();
          if (!c || c === r) return;
          let u = T(
            this.options_.filter((e) => {
              let [, t] = e;
              return t !== l;
            }),
            c
          );
          this.options_ = this.options_.map((e) => {
            let [t, o] = e;
            return o === l ? [c, u] : [t, o];
          });
          let d = this.workspace,
            p = this.getFieldValue("VAR");
          if ((C(d, p, this.options_), d && p)) {
            let e = d.getAllBlocks(!1).find((e) => {
              var t;
              return (
                "variables_set_option" === e.type &&
                (null === (t = e.getFieldValue) || void 0 === t
          ...
          null === (a = this.getField("OPTION")) ||
            void 0 === a ||
            a.setValue(u);
        },
        mutationToDom() {
          let e = document.createElement("mutation");
          return e.setAttribute("options", h(this.options_)), e;
        },
        domToMutation(e) {
          var t;
          let o = m(e.getAttribute("options"));
          this.options_ = o;
          let i = this.workspace;
          C(
            i,
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.variables_is_option =
          (e) => {
            let t = window.Blockly.JavaScript.variableDB_.getName(
                e.getFieldValue("VAR"),
                window.Blockly.Variables.CATEGORY_NAME
    ...
    BinaryBotPrivateAfterPurchase = function BinaryBotPrivateAfterPurchase() {
        ...
        // When the last trade was a virtual trade (VH), skip executing restart condition blocks
        // to avoid mixing virtual trade calculations with real account logic.
        // This uses wasLastTradeVirtual() instead of getVHStatus() because VH status may change
        // after the trade completes but before this block runs.
        if (Bot.wasLastTradeVirtual()) {
          ...
          args0: [
            {
              type: "field_dropdown",
              name: "CHECK_RESULT",
              options: (0, S.vc)().lists.CHECK_RESULT,
            },
          ],
          output: "Boolean",
          outputShape: window.Blockly.OUTPUT_SHAPE_ROUND,
...
`;
      ...
      (window.Blockly.Blocks.apollo_purchase = {
        ...
        definition: () => ({
          ...
          message1: (0, i.NC)("Allow Bulk Purchase: %1"),
          args0: [
            {
              type: "field_dropdown",
              name: "PURCHASE_LIST",
          ...
          message2: (0, i.NC)("No. of Trades: %1"),
          args2: [
            {
              type: "field_number",
          ...
          colourTertiary: window.Blockly.Colours.Special1.colourTertiary,
          tooltip: (0, i.NC)(
            "This block purchases contract of a specified type. Enable Multiple Contracts to execute multiple trades at once."
          ),
          category: window.Blockly.Categories.Before_Purchase,
        }),
        meta: () => ({
        ...
        onchange(e) {
          if (
            ...
            if (
              ...
              if ("TYPE_LIST" === e.name || "TRADETYPE_LIST" === e.name)
                this.populatePurchaseList(e);
              else if ("MULTIPLE_CONTRACTS" === e.name) {
                let e = "TRUE" === this.getFieldValue("MULTIPLE_CONTRACTS");
                this.getInput("CONTRACT_QUANTITY").setVisible(e);
              }
            } else
              e.type === window.Blockly.Events.BLOCK_DRAG &&
                !e.isStart &&
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.apollo_purchase =
          (e) => {
            let t = e.getFieldValue("PURCHASE_LIST"),
              o = "TRUE" === e.getFieldValue("MULTIPLE_CONTRACTS"),
              i = e.getFieldValue("CONTRACT_QUANTITY") || 1;
            return o
              ? `Bot.multiplePurchase('${t}', ${Number(i)});
`
              : `Bot.purchase('${t}');
`;
          }),
        (window.Blockly.Blocks.apollo_purchase2 = {
            ...
            args0: [
              {
                ...
                options: [
                  [(0, i.NC)("Rise"), "CALL"],
                  [(0, i.NC)("Fall"), "PUT"],
                  [(0, i.NC)("Even"), "DIGITEVEN"],
                  [(0, i.NC)("Odd"), "DIGITODD"],
                  [(0, i.NC)("Over"), "DIGITOVER"],
                  [(0, i.NC)("Under"), "DIGITUNDER"],
                  [(0, i.NC)("Matches"), "DIGITMATCH"],
                  [(0, i.NC)("Differs"), "DIGITDIFF"],
                ],
              },
            ],
            message1: (0, i.NC)("Prediction: %1"),
          ...
          onchange(e) {
            if (
              ...
              this.updatePredictionVisibility_(e);
          },
          updatePredictionVisibility_(e) {
            let t = [
                "DIGITOVER",
                "DIGITUNDER",
                "DIGITMATCH",
                "DIGITDIFF",
              ].includes(this.getFieldValue("PURCHASE_LIST")),
              o = this.getInput("PREDICTION");
            o && o.setVisible(t);
            let i =
              e &&
              e.type === window.Blockly.Events.BLOCK_CHANGE &&
              e.blockId === this.id &&
              "PURCHASE_LIST" === e.name;
            t && i && this.ensurePredictionShadow_(),
              this.rendered && this.render();
          },
          ensurePredictionShadow_() {
            let e = this.getInput("PREDICTION");
            if (
              !(null == e ? void 0 : e.connection) ||
              e.connection.targetBlock()
            )
              return;
            let t = this.workspace.newBlock("math_number_positive");
            t.setShadow(!0),
              t.setFieldValue(1, "NUM"),
              t.outputConnection.connect(e.connection),
              t.initSvg(),
              t.render();
          },
          customContextMenu(e) {
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.apollo_purchase2 =
          (e) => {
            let t = e.getFieldValue("PURCHASE_LIST");
            if (
...
`;
        ...
        (window.Blockly.Blocks.ask_price = {
          ...
          populatePurchaseList:
            window.Blockly.Blocks.apollo_purchase.populatePurchaseList,
          enforceLimitations:
            window.Blockly.Blocks.apollo_purchase.enforceLimitations,
        }),
      ...
      let E = (e) =>
        ["DIGITOVER", "DIGITUNDER", "DIGITMATCH", "DIGITDIFF"].includes(e);
      (window.Blockly.Blocks.apollo_hedge_purchase = {
        init() {
          this.jsonInit(this.definition()),
            this.setNextStatement(!1),
            this.createPredictionInputs();
        },
        definition: () => ({
          message0: (0, i.NC)("Hedge: Buy {{ a }} and {{ b }}", {
            a: "%1",
            b: "%2",
          }),
          args0: [
            { type: "field_dropdown", name: "PURCHASE_A", options: [["", ""]] },
            { type: "field_dropdown", name: "PURCHASE_B", options: [["", ""]] },
          ],
          message1: (0, i.NC)("Prediction A: {{ pred }}", { pred: "%1" }),
          args1: [
            { type: "input_value", name: "PREDICTION_A", check: "Number" },
          ],
          message2: (0, i.NC)("Prediction B: {{ pred }}", { pred: "%1" }),
          args2: [
            { type: "input_value", name: "PREDICTION_B", check: "Number" },
          ],
          previousStatement: null,
          colour: window.Blockly.Colours.Special1.colour,
          colourSecondary: window.Blockly.Colours.Special1.colourSecondary,
          colourTertiary: window.Blockly.Colours.Special1.colourTertiary,
          tooltip: (0, i.NC)(
            'Execute two purchases in the same tick (hedge). For opposites like Higher/Lower or Over/Under, set Contract Type to "Both" in Trade parameters so proposals are available.'
          ),
          category: window.Blockly.Categories.Before_Purchase,
        }),
        meta: () => ({
          display_name: (0, i.NC)("Hedge purchase (2 at once)"),
          description: (0, i.NC)(
            "Buy two contracts at the same time. Useful for hedging, e.g., Higher and Lower or Over and Under with different digits."
          ),
          key_words: (0, i.NC)("buy, hedge, dual, simultaneous"),
        }),
        createPredictionInputs() {
          let e = (e) => {
            let t = this.getInput(e) || this.appendValueInput(e);
            if (!t.connection.targetBlock()) {
              let e = this.workspace.newBlock("math_number_positive");
              e.setShadow(!0),
                e.setFieldValue(1, "NUM"),
                e.outputConnection.connect(t.connection),
                e.initSvg(),
                e.renderEfficiently();
            }
          };
          e("PREDICTION_A"), e("PREDICTION_B");
        },
        onchange(e) {
          if (
            !(
            ...
            if (
              ...
              this.populatePurchaseLists(e), this.updatePredictionVisibility();
            else if (e.type === window.Blockly.Events.BLOCK_CHANGE)
              ["TYPE_LIST", "TRADETYPE_LIST"].includes(e.name)
                ? (this.populatePurchaseLists(e),
                  this.updatePredictionVisibility())
                : ["PURCHASE_A", "PURCHASE_B"].includes(e.name) &&
                  this.updatePredictionVisibility();
            else if (
              e.type === window.Blockly.Events.BLOCK_DRAG &&
              !e.isStart &&
              ...
              let t = this.getField("PURCHASE_A"),
                o = null == t ? void 0 : t.menuGenerator_;
              o && o[0] && "" === o[0][0] && this.populatePurchaseLists(e),
                this.updatePredictionVisibility();
            }
          }
        },
        populatePurchaseLists(e) {
          let t = this.workspace.getTradeDefinitionBlock();
          if (!t) return;
          let o = t.getChildByType("trade_definition_tradetype"),
            i = null == o ? void 0 : o.getFieldValue("TRADETYPE_LIST"),
            a = this.getField("PURCHASE_A"),
            l = this.getField("PURCHASE_B");
          if (!a || !l) return;
          let n = (0, f.M)("both", i) || [],
            r = a.getValue(),
            s = l.getValue();
        ...
        updatePredictionVisibility() {
          let e = this.getFieldValue("PURCHASE_A"),
            t = this.getFieldValue("PURCHASE_B"),
            o = this.getInput("PREDICTION_A"),
            i = this.getInput("PREDICTION_B");
          o && o.setVisible(E(e)), i && i.setVisible(E(t));
        },
        customContextMenu(e) {
          let t = [(0, i.NC)("Enable Block"), (0, i.NC)("Disable Block")];
          (0, a.ei)(e, t), (0, a.Z3)(e);
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.apollo_hedge_purchase =
          (e) => {
            let t = e.getFieldValue("PURCHASE_A"),
              o = e.getFieldValue("PURCHASE_B");
            if (!t || !o) return "";
            let i = [
                "DIGITOVER",
                "DIGITUNDER",
              ...
              n = a
                ...
                : null;
            return `Bot.hedgePurchase('${t}', '${o}', ${i ? l : "null"}, ${
              a ? n : "null"
            });
`;
          }),
...
`;
            ...
            args0: [
              {
                ...
                options: (0, S.vc)().candleIntervals,
              },
            ],
            output: "Array",
            outputShape: window.Blockly.OUTPUT_SHAPE_ROUND,
            ...
            args0: [
              {
                ...
                options: (0, S.vc)().lists.CHECK_DIRECTION,
              },
            ],
            output: "Boolean",
            outputShape: window.Blockly.OUTPUT_SHAPE_ROUND,
        ...
        (window.Blockly.Blocks.check_candle_color = {
          init() {
            this.jsonInit(this.definition());
          },
          definition: () => ({
            message0: (0, i.NC)("Candle is {{ candle_color }}", {
              candle_color: "%1",
            }),
            args0: [
              {
                type: "field_dropdown",
                name: "CHECK_CANDLE_COLOR",
                options: (0, S.vc)().lists.CHECK_CANDLE_COLOR,
              },
            ],
            output: "Boolean",
            outputShape: window.Blockly.OUTPUT_SHAPE_ROUND,
            ...
            colourTertiary: window.Blockly.Colours.Base.colourTertiary,
            tooltip: (0, i.NC)(
              "True if the current candle color matches the selection"
            ),
            category: window.Blockly.Categories.Tick_Analysis,
          }),
          meta: () => ({
            display_name: (0, i.NC)("Candle color"),
            description: (0, i.NC)(
              'This block is used to determine if the current candle is green or red. It gives you a value of "True" or "False". Green candle means close price is higher than open price, red candle means close price is lower than open price.'
            ),
          }),
          customContextMenu(e) {
            (0, a.Z3)(e);
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.check_candle_color =
          (e) => {
            let t = e.getFieldValue("CHECK_CANDLE_COLOR");
            return [
              `Bot.checkCandleColor('${t}')`,
              window.Blockly.JavaScript.javascriptGenerator.ORDER_ATOMIC,
            ];
          }),
...
`;
        ...
        (window.Blockly.Blocks.second_last_digit = {
          ...
          definition: () => ({
            message0: (0, i.NC)("Second Last Digit"),
            output: "Number",
            outputShape: window.Blockly.OUTPUT_SHAPE_ROUND,
            colour: window.Blockly.Colours.Base.colour,
            colourSecondary: window.Blockly.Colours.Base.colourSecondary,
            colourTertiary: window.Blockly.Colours.Base.colourTertiary,
            tooltip: (0, i.NC)("Returns the last digit of the previous tick"),
            category: window.Blockly.Categories.Tick_Analysis,
          }),
          meta: () => ({
            display_name: (0, i.NC)("Second Last Digit"),
            description: (0, i.NC)(
              "This block gives you the last digit of the previous tick value."
            ),
          }),
          customContextMenu(e) {
            (0, a.Z3)(e);
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.second_last_digit =
          () => [
            "Bot.getSecondLastDigit()",
            window.Blockly.JavaScript.javascriptGenerator.ORDER_ATOMIC,
          ]),
        (window.Blockly.Blocks.nth_last_digit = {
          init() {
            this.jsonInit(this.definition());
            let e = this.getInput("N");
            if (e && !e.connection.targetBlock()) {
              let t = this.workspace.newBlock("math_number");
              t.setShadow(!0),
                t.setFieldValue("3", "NUM"),
                t.outputConnection.connect(e.connection);
            }
          },
          definition: () => ({
            message0: (0, i.NC)("Get the %1 last digit"),
            ...
            colourTertiary: window.Blockly.Colours.Base.colourTertiary,
            tooltip: (0, i.NC)(
              "Returns the last digit of the Nth previous tick"
            ),
            category: window.Blockly.Categories.Tick_Analysis,
          }),
          meta: () => ({
            display_name: (0, i.NC)("Nth Last Digit"),
            description: (0, i.NC)(
              "This block gives you the last digit of the Nth previous tick value."
            ),
          }),
          customContextMenu(e) {
            (0, a.Z3)(e);
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.nth_last_digit =
          (e) => {
            let t =
              window.Blockly.JavaScript.javascriptGenerator.valueToCode(
                e,
        ...
        (window.Blockly.Blocks.lastNDigitsList = {
          init() {
            this.jsonInit(this.definition());
            let e = this.getInput("N");
            if (e && !e.connection.targetBlock()) {
          ...
          definition: () => ({
            message0: (0, i.NC)("Last %1 digits", { "%1": "%1" }),
            args0: [{ type: "input_value", name: "N", check: "Number" }],
            output: "Array",
            outputShape: window.Blockly.OUTPUT_SHAPE_ROUND,
            colour: window.Blockly.Colours.Base.colour,
            colourSecondary: window.Blockly.Colours.Base.colourSecondary,
            colourTertiary: window.Blockly.Colours.Base.colourTertiary,
            tooltip: (0, i.NC)("Returns the last N digits from a digit list"),
            category: window.Blockly.Categories.Tick_Analysis,
          }),
          meta: () => ({
            display_name: (0, i.NC)("Last N Digits List"),
            description: (0, i.NC)(
              "This block extracts the last N digits from a digit list, useful for analyzing recent digit patterns."
            ),
          }),
          customContextMenu(e) {
            (0, a.Z3)(e);
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.lastNDigitsList =
          (e) => {
            let t =
                window.Blockly.JavaScript.javascriptGenerator.valueToCode(
                  e,
        ...
        (window.Blockly.Blocks.last_digits_condition = {
          init() {
            if (
              (this.jsonInit(this.definition()),
              this.setInputsInline(!0),
              !this.getInput("N").connection.targetBlock())
            ) {
              let e = this.workspace.newBlock("math_number");
              e.setShadow(!0),
                e.setFieldValue("3", "NUM"),
                e.outputConnection.connect(this.getInput("N").connection);
            }
            this.getField("CONDITION").setValidator(
              (e) => (this.updateShape_(e), e)
            ),
              this.updateShape_(this.getFieldValue("CONDITION"));
          },
          updateShape_(e) {
            if (!["ALL_EVEN", "ALL_ODD", "ALL_SAME"].includes(e)) {
              if (
                !this.getInput("COMPARE_VALUE") &&
                (this.appendValueInput("COMPARE_VALUE")
                  .setCheck("Number")
                  .appendField((0, i.NC)("digit")),
                !this.getInput("COMPARE_VALUE").connection.targetBlock())
              ) {
                let e = this.workspace.newBlock("math_number");
                e.setShadow(!0),
                  e.setFieldValue("4", "NUM"),
                  e.outputConnection.connect(
                    this.getInput("COMPARE_VALUE").connection
                  );
              }
            } else
              this.getInput("COMPARE_VALUE") &&
          ...
          definition: () => ({
            message0: (0, i.NC)("Last %1 digits are %2", {
              "%1": "%1",
              "%2": "%2",
            }),
            args0: [
              { type: "input_value", name: "N", check: "Number" },
              {
                ...
                name: "CONDITION",
                options: [
                  [(0, i.NC)("all even"), "ALL_EVEN"],
                  [(0, i.NC)("all odd"), "ALL_ODD"],
                  [(0, i.NC)("all same"), "ALL_SAME"],
                  [(0, i.NC)("less than"), "LESS_THAN"],
                  [(0, i.NC)("greater than"), "GREATER_THAN"],
                  [(0, i.NC)("less than or equal to"), "LESS_OR_EQUAL"],
                  [(0, i.NC)("greater than or equal to"), "GREATER_OR_EQUAL"],
                ],
              },
            ],
            output: "Boolean",
            ...
            colourTertiary: window.Blockly.Colours.Base.colourTertiary,
            tooltip: (0, i.NC)(
              "Checks conditions on last N digits of tick values"
            ),
            category: window.Blockly.Categories.Tick_Analysis,
          }),
          saveExtraState() {
          ...
          loadExtraState(e) {
            this.setFieldValue(e.condition, "CONDITION"),
              this.updateShape_(e.condition);
          },
          meta: () => ({
            display_name: (0, i.NC)("Last Digits Condition"),
            description: (0, i.NC)(
              "Checks if last N digits meet specified condition"
            ),
          }),
          customContextMenu(e) {
            (0, a.Z3)(e);
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.last_digits_condition =
          (e) => {
            let t =
              ...
              o = e.getFieldValue("CONDITION"),
              i = "4";
            e.getInput("COMPARE_VALUE") &&
              (i =
                window.Blockly.JavaScript.javascriptGenerator.valueToCode(
                  e,
                  "COMPARE_VALUE",
            ...
            let a =
              window.Blockly.JavaScript.javascriptGenerator.provideFunction_(
                ...
                [
                  "function " +
                    window.Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
                    '(n, condition, compare_value) {var result = Bot.checkLastDigitsCondition(n, condition, compare_value);var condition_text = "";var digits = Bot.getLastDigitList().slice(-n);switch (condition) {case "ALL_EVEN": condition_text = "all even"; break;case "ALL_ODD": condition_text = "all odd"; break;case "ALL_SAME": condition_text = "all same (" + (digits.length > 0 ? digits[0] : "?") + ")"; break;case "LESS_THAN": condition_text = "less than " + compare_value; break;case "GREATER_THAN": condition_text = "greater than " + compare_value; break;case "LESS_OR_EQUAL": condition_text = "less than or equal to " + compare_value; break;case "GREATER_OR_EQUAL": condition_text = "greater than or equal to " + compare_value; break;}var market = "N/A";try {if (typeof config_v1 !== "undefined" && config_v1.other_symbol && config_v1.other_symbol.isActive && config_v1.other_symbol.symbol) {market = config_v1.other_symbol.symbol;} else if (typeof Bot !== "undefined" && Bot.symbol) {market = Bot.symbol;}} catch (e) { market = "N/A"; }Bot.notify({message: "Last Digits Analysis\\n" +"Market: " + market + "\\n" +"Condition: " + condition_text + "\\n" +"Digits: [" + digits.join(", ") + "]\\n" +"Result: " + (result ? "✅ TRUE" : "❌ FALSE"),className: "journal__text--" + (result ? "success" : "info"),sound: "silent"});return result;}',
                ]
              );
            return [
              `${a}(${t}, '${o}', ${i})`,
        ...
        (window.Blockly.Blocks.digit_frequency_analysis = {
          init() {
            this.jsonInit({
              message0: (0, i.NC)("%1 digit from last %2 digits"),
              args0: [
                {
                  type: "field_dropdown",
                  name: "ANALYSIS_TYPE",
                  options: [
                    [(0, i.NC)("Most frequent"), "MOST_FREQUENT"],
                    [(0, i.NC)("Second most frequent"), "SECOND_MOST_FREQUENT"],
                    [(0, i.NC)("Least frequent"), "LEAST_FREQUENT"],
                    [
                      (0, i.NC)("Second least frequent"),
              ...
              colourTertiary: window.Blockly.Colours.Base.colourTertiary,
              tooltip: (0, i.NC)(
                "Returns frequency analysis of last N digits with percentage notification"
              ),
              category: window.Blockly.Categories.Tick_Analysis,
              inputsInline: !0,
            });
            ...
            if (e && !e.connection.targetBlock()) {
              let t = this.workspace.newBlock("math_number");
              t.setShadow(!0),
                t.setFieldValue("1000", "NUM"),
                t.outputConnection.connect(e.connection);
            }
          },
          meta: () => ({
            display_name: (0, i.NC)("Digit Frequency Analysis"),
            description: (0, i.NC)(
              "Finds frequency patterns in last N digits and shows full ranking"
            ),
          }),
          customContextMenu(e) {
            (0, a.Z3)(e);
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.digit_frequency_analysis =
          function (e) {
            let t = e.getFieldValue("ANALYSIS_TYPE"),
              o =
                window.Blockly.JavaScript.javascriptGenerator.valueToCode(
                  e,
                  "N",
              ...
              i =
                window.Blockly.JavaScript.javascriptGenerator.provideFunction_(
                  ...
                  [
                    ...
                    '      Bot.notify("No digits available for frequency analysis", "error");',
                    "      return 0;",
                    "    }",
                    "    ",
                    ...
                    "    }",
                    "    ",
                    "    // Create and sort digit data",
                    "    var digitData = [];",
                    "    for (var d = 0; d < 10; d++) {",
                    "      if (frequency[d] > 0) {",
                    "        digitData.push({",
                    "          digit: d,",
                    "          percentage: Math.round((frequency[d]/total)*10000)/100",
                    "        });",
                    "      }",
                    "    }",
                    "    ",
                    "    // Bubble sort by percentage",
                    "    for (var i = 0; i < digitData.length-1; i++) {",
                    "      for (var j = 0; j < digitData.length-i-1; j++) {",
                    "        if (digitData[j].percentage < digitData[j+1].percentage) {",
                    "          var temp = digitData[j];",
                    "          digitData[j] = digitData[j+1];",
                    "          digitData[j+1] = temp;",
                    "        }",
                    "      }",
                    "    }",
                    ...
                    '    var msg = "Most Appearing \uD83D\uDFE2>>> \\n";',
                    '    if (digitData.length > 0) msg += digitData[0].digit + " \uD83D\uDC49 " + digitData[0].percentage + "%  ||  \\n";',
                    '    if (digitData.length > 1) msg += "2nd Most Appearing \uD83D\uDD35>>> " + digitData[1].digit + " \uD83D\uDC49 " + digitData[1].percentage + "%  ||  \\n";',
                    '    msg += "\\nLeast Appearing \uD83D\uDD34>>>  \\n";',
                    '    if (digitData.length > 0) msg += digitData[digitData.length-1].digit + " \uD83D\uDC49 " + digitData[digitData.length-1].percentage + "%\\n";',
                    '    if (digitData.length > 1) msg += "2nd Least Appearing \uD83D\uDFE0>>> " + digitData[digitData.length-2].digit + " \uD83D\uDC49 " + digitData[digitData.length-2].percentage + "%\\n";',
                    '    msg += "\\nBased on last " + total + " ticks";',
                    "    ",
                    "    Bot.notify({",
                    "      message: msg,",
                    '      className: "journal__text--information",',
                    '      sound: "silent" // Changed to silent to prevent sound errors',
                    "    });",
                    "    ",
                    "    // Return requested digit",
                    "    if (digitData.length === 0) return 0;",
                    "    switch(type) {",
                    '      case "MOST_FREQUENT": return digitData[0].digit;',
                    '      case "SECOND_MOST_FREQUENT": return digitData.length > 1 ? digitData[1].digit : digitData[0].digit;',
                    '      case "LEAST_FREQUENT": return digitData[digitData.length-1].digit;',
                    '      case "SECOND_LEAST_FREQUENT": return digitData.length > 1 ? digitData[digitData.length-2].digit : digitData[0].digit;',
                    "      default: return 0;",
                    "    }",
                    "  } catch(e) {",
                    '    console.error("Digit analysis error:", e);',
                    "    return 0;",
                    "  }",
                    "}",
                  ]
            ...
            return [
              i + "(Bot.getLastDigitList().slice(-" + o + '), "' + t + '")',
              window.Blockly.JavaScript.javascriptGenerator.ORDER_FUNCTION_CALL,
            ];
          }),
        (window.Blockly.Blocks.even_odd_analysis = {
          init() {
            this.jsonInit(this.definition()), this.setInputsInline(!0);
            let e = this.getInput("N");
            if (e && !e.connection.targetBlock()) {
              let t = this.workspace.newBlock("math_number");
              t.setShadow(!0),
          ...
          definition: () => ({
            message0: (0, i.NC)("%1 of last %2 digits"),
            args0: [
              {
                type: "field_dropdown",
                name: "ANALYSIS_TYPE",
                options: [
                  [(0, i.NC)("Even %"), "EVEN_PERCENTAGE"],
                  [(0, i.NC)("Odd %"), "ODD_PERCENTAGE"],
                ],
              },
              { type: "input_value", name: "N", check: "Number" },
            ],
            ...
            colourTertiary: window.Blockly.Colours.Base.colourTertiary,
            tooltip: (0, i.NC)(
              "Analyzes percentage of even or odd digits in last N ticks"
            ),
            category: window.Blockly.Categories.Tick_Analysis,
          }),
          meta: () => ({
            display_name: (0, i.NC)("Even/Odd %"),
            description: (0, i.NC)(
              "Returns percentage of even or odd digits from last N ticks"
            ),
          }),
          customContextMenu(e) {
            (0, a.Z3)(e);
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.even_odd_analysis =
          function (e) {
            let t = e.getFieldValue("ANALYSIS_TYPE"),
              o =
                window.Blockly.JavaScript.javascriptGenerator.valueToCode(
        ...
        (window.Blockly.Blocks.over_under_analysis = {
          init() {
            this.jsonInit(this.definition()), this.setInputsInline(!0);
            let e = this.getInput("DIGIT");
            if (e && !e.connection.targetBlock()) {
              let t = this.workspace.newBlock("math_number");
              t.setShadow(!0),
                t.setFieldValue("4", "NUM"),
                t.outputConnection.connect(e.connection);
            }
            let t = this.getInput("N");
            if (t && !t.connection.targetBlock()) {
              let e = this.workspace.newBlock("math_number");
              e.setShadow(!0),
                e.setFieldValue("1000", "NUM"),
                e.outputConnection.connect(t.connection);
            }
          },
          definition: () => ({
            message0: (0, i.NC)("%1 %2 % in last %3 ticks"),
            args0: [
              {
                type: "field_dropdown",
                name: "CONDITION_TYPE",
            ...
            colourTertiary: window.Blockly.Colours.Base.colourTertiary,
            tooltip: (0, i.NC)(
              "Analyzes percentage of digits above/below specified value in last N ticks"
            ),
            category: window.Blockly.Categories.Tick_Analysis,
          }),
          meta: () => ({
            display_name: (0, i.NC)("Over/Under Analysis"),
            description: (0, i.NC)(
              "Returns percentage of digits above/below specified threshold from last N ticks"
            ),
          }),
          customContextMenu(e) {
            (0, a.Z3)(e);
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.over_under_analysis =
          function (e) {
            let t = e.getFieldValue("CONDITION_TYPE"),
              o =
                window.Blockly.JavaScript.javascriptGenerator.valueToCode(
                  e,
                  "DIGIT",
              ...
              a =
                window.Blockly.JavaScript.javascriptGenerator.provideFunction_(
                  ...
                  [
                    ...
                    "    var over_count = 0;",
                    "    var under_count = 0;",
                    "    compareDigit = parseInt(compareDigit, 10);",
                    "    ",
                    "    for (var i = 0; i < digits.length; i++) {",
                    "      if (digits[i] > compareDigit) over_count++;",
                    "      else under_count++;",
                    "    }",
                    "    ",
                    "    var total = digits.length;",
                    "    var over_pct = Math.round((over_count/total)*10000)/100;",
                    "    var under_pct = Math.round((under_count/total)*10000)/100;",
                    "    ",
                    "    Bot.notify({",
                    '      message: "Over \uD83D\uDFE2: " + over_pct + "%\\n" +',
                    '               "Under \uD83D\uDD34: " + under_pct + "%\\n\\n" +',
                    '               "Based on last " + total + " digits",',
                    '      className: "journal__text--information",',
                    '      sound: "silent"',
                    "    });",
                    "    ",
                    '    return condition === "OVER" ? over_pct : under_pct;',
                    "  } catch(e) {",
                    '    console.error("Over/Under analysis error:", e);',
                    "    return 0;",
                    "  }",
                    "}",
                  ]
        ...
        (window.Blockly.Blocks.match_differ_analysis = {
          ...
          definition: () => ({
            ...
            colourTertiary: window.Blockly.Colours.Base.colourTertiary,
            tooltip: (0, i.NC)(
              "Analyzes percentage of digits matching or differing from specified value in last N ticks"
            ),
            category: window.Blockly.Categories.Tick_Analysis,
          }),
          meta: () => ({
            display_name: (0, i.NC)("Match/Differ Analysis"),
            description: (0, i.NC)(
              "Returns percentage of digits matching or differing from specified value in last N ticks"
            ),
          }),
          customContextMenu(e) {
            (0, a.Z3)(e);
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.match_differ_analysis =
          function (e) {
            let t = e.getFieldValue("CONDITION_TYPE"),
              o =
                window.Blockly.JavaScript.javascriptGenerator.valueToCode(
              ...
              a =
                window.Blockly.JavaScript.javascriptGenerator.provideFunction_(
                  ...
                  [
                    ...
                    "    ",
                    "    for (var i = 0; i < digits.length; i++) {",
                    "      if (digits[i] === compareDigit) match_count++;",
                    "      else differ_count++;",
                    "    }",
                    "    ",
                    "    var total = digits.length;",
                    "    var match_pct = Math.round((match_count/total)*10000)/100;",
                    "    var differ_pct = Math.round((differ_count/total)*10000)/100;",
                    "    ",
                    "    Bot.notify({",
                    '      message: "Match \uD83D\uDFE2: " + match_pct + "%\\n" +',
                    '               "Differ \uD83D\uDD34: " + differ_pct + "%\\n\\n" +',
                    '               "Compared to digit: " + compareDigit + "\\n" +',
                    '               "Based on last " + total + " digits",',
                    '      className: "journal__text--information",',
                    '      sound: "silent"',
                    "    });",
                    "    ",
                    '    return condition === "MATCH" ? match_pct : differ_pct;',
                    "  } catch(e) {",
                    '    console.error("Match/Differ analysis error:", e);',
                    "    return 0;",
                    "  }",
                    "}",
                  ]
        ...
        (window.Blockly.Blocks.rise_fall_analysis = {
          init() {
            this.jsonInit(this.definition()), this.setInputsInline(!0);
            let e = this.getInput("N");
            if (e && !e.connection.targetBlock()) {
          ...
          definition: () => ({
            message0: (0, i.NC)("%1 of last %2 ticks"),
            args0: [
              {
                type: "field_dropdown",
                name: "ANALYSIS_TYPE",
                options: [
                  [(0, i.NC)("Rise %"), "RISE_PERCENTAGE"],
                  [(0, i.NC)("Fall %"), "FALL_PERCENTAGE"],
                ],
              },
              { type: "input_value", name: "N", check: "Number" },
            ],
            ...
            colourTertiary: window.Blockly.Colours.Base.colourTertiary,
            tooltip: (0, i.NC)(
              "Analyzes percentage of rising, falling, or unchanged ticks in last N ticks"
            ),
            category: window.Blockly.Categories.Tick_Analysis,
          }),
          meta: () => ({
            display_name: (0, i.NC)("Rise/Fall %"),
            description: (0, i.NC)(
              "Returns percentage of rising or falling ticks (including unchanged) from last N ticks"
            ),
          }),
          customContextMenu(e) {
            (0, a.Z3)(e);
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.rise_fall_analysis =
          function (e) {
            let t = e.getFieldValue("ANALYSIS_TYPE"),
              o =
                window.Blockly.JavaScript.javascriptGenerator.valueToCode(
              ...
              i =
                window.Blockly.JavaScript.javascriptGenerator.provideFunction_(
                  ...
                  [
                    ...
                    '      Bot.notify("Not enough ticks for analysis", "error");',
                    "      return 0;",
                    "    }",
                    "    ",
                    "    var rise_count = 0;",
                    ...
                    "      if (ticks[i] > ticks[i-1]) rise_count++;",
                    "      else if (ticks[i] < ticks[i-1]) fall_count++;",
                    "      else no_change_count++;",
                    "    }",
                    "    ",
                    "    var total_movements = ticks.length - 1;",
                    "    var rise_pct = Math.round((rise_count/total_movements)*10000)/100;",
                    "    var fall_pct = Math.round((fall_count/total_movements)*10000)/100;",
                    "    var no_change_pct = Math.round((no_change_count/total_movements)*10000)/100;",
                    "    ",
                    "    // Adjust for rounding errors to ensure sum equals 100%",
                    "    var sum = rise_pct + fall_pct + no_change_pct;",
                    "    if (sum !== 100) {",
                    "      var diff = 100 - sum;",
                    "      no_change_pct += diff; // Apply adjustment to no_change_pct",
                    "    }",
                    "    ",
                    "    Bot.notify({",
                    '      message: "\uD83D\uDCCA Tick Movement Analysis\\n\\n" +',
                    '               "Rise \uD83D\uDFE2: " + rise_pct + "%\\n" +',
                    '               "Fall \uD83D\uDD34: " + fall_pct + "%\\n" +',
                    '               "No change ⚪: " + no_change_pct + "%",',
                    '      className: "journal__text--information",',
                    '      sound: "silent"',
                    "    });",
                    "    ",
                    '    return type === "RISE_PERCENTAGE" ? rise_pct : fall_pct;',
                    "  } catch(e) {",
                    '    console.error("Rise/Fall analysis error:", e);',
                    "    return 0;",
                    "  }",
                    "}",
                  ]
        ...
        (window.Blockly.Blocks.lastNTicksDirection = {
          init() {
            this.jsonInit(this.definition());
            let e = this.getInput("N");
            if (e && !e.connection.targetBlock()) {
          ...
          definition: () => ({
            message0: (0, i.NC)(
              "Last %1 ticks direction is {{ direction_type }}",
              { direction_type: "%2" }
            ),
            args0: [
              { type: "input_value", name: "N", check: "Number" },
            ...
            colourTertiary: window.Blockly.Colours.Base.colourTertiary,
            tooltip: (0, i.NC)(
              "True if the last N ticks are all in the selected direction"
            ),
            category: window.Blockly.Categories.Tick_Analysis,
          }),
          meta: () => ({
            display_name: (0, i.NC)("Last N Ticks Direction"),
            description: (0, i.NC)(
              'This block checks if the last N ticks are all rising or all falling. It gives you a value of "True" or "False".'
            ),
          }),
          customContextMenu(e) {
            (0, a.Z3)(e);
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.lastNTicksDirection =
          (e) => {
            let t =
                window.Blockly.JavaScript.javascriptGenerator.valueToCode(
                  e,
              ...
              o = e.getFieldValue("CHECK_DIRECTION"),
              i =
                window.Blockly.JavaScript.javascriptGenerator.provideFunction_(
                  "checkLastNTicksDirection",
                  [
                    `function ${window.Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_}(count, direction, ticks) {
        if (!ticks || !ticks.length) {
            Bot.notify("No ticks available for analysis", "error");
            return false;
        }

        var n = Math.max(1, parseInt(count, 10));
        if (ticks.length < n + 1) {
            Bot.notify("Not enough ticks for analysis", "error");
            return false;
        }

        // Get the last n+1 ticks to calculate n movements
        var lastTicks = ticks.slice(-(n + 1));

        var isDirectionMatch = true;
        var direction_text = "";
        var tickDirections = [];

        // Determine user-selected direction text
        switch (direction) {
            case 'rise':
        ...
        // Determine each tick movement as R or F
        for (var i = 1; i < lastTicks.length; i++) {
            if (lastTicks[i] > lastTicks[i - 1]) {
                tickDirections.push("R");
            } else if (lastTicks[i] < lastTicks[i - 1]) {
                tickDirections.push("F");
            } else {
                tickDirections.push("N");
            }

            // Compare to target direction
            if (direction === 'rise' && lastTicks[i] <= lastTicks[i - 1]) {
                isDirectionMatch = false;
                break;
            } else if (direction === 'fall' && lastTicks[i] >= lastTicks[i - 1]) {
                isDirectionMatch = false;
                break;
            } else if (direction === '' && lastTicks[i] !== lastTicks[i - 1]) {
                isDirectionMatch = false;
                break;
            }
        }

        // Notify with direction sequence instead of tick values
        Bot.notify({
            message:
                "Last Ticks Direction Analysis\\n\\n" +
                "Direction: " + direction_text + "\\n" +
                "Sequence: [" + tickDirections.join(', ') + "]\\n" +
                "Result: " + (isDirectionMatch ? "✅ TRUE" : "❌ FALSE"),
            className: "journal__text--" + (isDirectionMatch ? "success" : "info"),
            sound: "silent"
        });
            ...
            args0: [
              {
                type: "field_dropdown",
                name: "BALANCE_TYPE",
                options: (0, S.vc)().lists.BALANCE_TYPE,
              },
            ],
            output: null,
            outputShape: window.Blockly.OUTPUT_SHAPE_ROUND,
      ...
      (window.Blockly.Blocks.loader = {
        ...
        loadBlocksFromCurrentUrl() {
          (this.current_url = this.getFieldValue("URL")),
            ...
            (0, a.oG)(this)
              .then(() => {
                A.P.emit("ui.log.success", { log_type: N.v9.LOAD_BLOCK });
              })
              .catch((e) => {
                A.P.emit("ui.log.error", e), this.setDisabled(!0);
              });
        },
        isKnownUrl(e) {
          return this.workspace
            ...
            args0: [
              {
                ...
                options: (0, S.vc)().lists.NOTIFICATION_TYPE,
              },
              {
                type: "field_dropdown",
                name: "NOTIFICATION_SOUND",
                options: (0, S.vc)().lists.NOTIFICATION_SOUND,
              },
...
`;
        ...
        (window.Blockly.Blocks.apollo_notify = {
          ...
          definition: () => ({
            message0: (0, i.NC)(
              "MkoreanWWN-Notify {{ notification_type }} with sound: {{ notification_sound }} {{ input_message }}",
              {
                notification_type: "%1",
                notification_sound: "%2",
                input_message: "%3",
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.apollo_notify =
          (e) => {
            let t = e.getFieldValue("NOTIFICATION_TYPE"),
              o = e.getFieldValue("NOTIFICATION_SOUND"),
              a = e.getInputTargetBlock("MESSAGE"),
...
`;
        ...
        (window.Blockly.Blocks.vh_settings = {
          protected_statements: ["STATEMENT"],
          required_child_blocks: ["virtual_token", "max_steps", "min_trades"],
          init() {
            this.jsonInit(this.definition());
          },
          definition: () => ({
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.vh_settings = (
          e
        ) => {
          let t = e.childValueToCode("max_steps", "MAX_STEPS"),
            o = e.childValueToCode("min_trades", "MIN_TRADES");
          return `Bot.setVHSettings(${t}, ${o});
`;
        });
      let I = (e) => {
        let t = [[(0, i.NC)("disable"), "disable"]];
        for (let o in e)
      ...
      (window.Blockly.Blocks.contract_changer_block = {
        ...
        definition: () => ({
          message0: (0, i.NC)(
            "Current active contract {{ contract_changer }}",
            { contract_changer: "%1" }
          ),
          args0: [
            {
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.contract_changer_block =
          (e) => {
...
`;
        ...
        (window.Blockly.Blocks.get_last_digit = {
          ...
          definition: () => ({
            ...
            colourTertiary: Blockly.Colours.Base.colourTertiary,
            tooltip: (0, i.NC)(
              "This block returns the last item in a number value."
            ),
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.get_last_digit =
          (e) => {
            let t =
      ...
      (window.Blockly.Blocks.active_symbol_changer = {
          ...
          args0: [
            {
              ...
              options: (0, R.vc)().lists.OTHER_CONTRACTS_TYPES,
            },
          ],
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.active_symbol_changer =
          (e) => {
...
`;
        ...
        (window.Blockly.Blocks.custom_prediction_setter = {
          init() {
            if ((this.jsonInit(this.definition()), this.workspace)) {
              let e = this.getInput("PREDICTION_ACTIVE_TYPE");
              if (e && !e.connection.targetBlock()) {
                let t = this.workspace.newBlock("math_number_positive");
                t.setShadow(!0),
                  t.setFieldValue(1, "NUM"),
          ...
          definition: () => ({
            ...
            args0: [{ type: "input_value", name: "PREDICTION_ACTIVE_TYPE" }],
            colour: window.Blockly.Colours.Special3.colour,
            colourSecondary: window.Blockly.Colours.Special3.colourSecondary,
            colourTertiary: window.Blockly.Colours.Special3.colourTertiary,
            previousStatement: null,
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.custom_prediction_setter =
          (e) => {
            let t =
              window.Blockly.JavaScript.javascriptGenerator.valueToCode(
                e,
                "PREDICTION_ACTIVE_TYPE",
                window.Blockly.JavaScript.javascriptGenerator.ORDER_ATOMIC
              ) || "0";
...
`;
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.total_lost =
          () => ["Bot.getTotalLosts()", Blockly.JavaScript.ORDER_ATOMIC]),
        (window.Blockly.Blocks.total_wins = {
          init() {
            this.jsonInit(this.definition());
          },
          definition: () => ({
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.total_wins =
          () => ["Bot.getTotalWins()", Blockly.JavaScript.ORDER_ATOMIC]),
        (window.Blockly.Blocks.vh_status = {
          ...
          definition: () => ({
            ...
            colourTertiary: Blockly.Colours.Base.colourTertiary,
            tooltip: (0, i.NC)(
              "Returns the current status of the virtual hook"
            ),
            category: Blockly.Categories.Miscellaneous,
          }),
          meta: () => ({
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.vh_status =
          () => [
            "Bot.getVHStatus()",
            window.Blockly.JavaScript.javascriptGenerator.ORDER_ATOMIC,
          ]),
        (window.Blockly.Blocks.barrier_changer = {
          init() {
            this.jsonInit(this.definition());
          },
          definition: () => ({
          ...
          meta: () => ({
            ...
            description: (0, i.NC)(
              "Changes the offset of the a touch/notouch bot"
            ),
          }),
          getRequiredValueInputs: () => ({ TEXT: a.cM }),
        }),
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.barrier_changer =
          (e) => {
            let t =
              window.Blockly.JavaScript.javascriptGenerator.valueToCode(
                e,
...
`;
        ...
        (window.Blockly.Blocks.enable_barrier_changer = {
          ...
          definition: () => ({
            ...
            args0: [
              {
                ...
                options: (0, S.vc)().lists.BARRIER_OFFSETER_STATUS,
              },
            ],
            colour: Blockly.Colours.Special3.colour,
            colourSecondary: Blockly.Colours.Special3.colourSecondary,
            ...
            nextStatement: null,
            tooltip: (0, i.NC)(
              "Enable and Disable Touch/NoTouch offset changer feature"
            ),
            category: Blockly.Categories.Miscellaneous,
          }),
          customContextMenu(e) {
          ...
          meta: () => ({
            ...
            description: (0, i.NC)(
              "This block Enable and Disable Touch/NoTouch offset changer feature."
            ),
          }),
        }),
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.enable_barrier_changer =
          (e) => {
            let t = e.getFieldValue("BARRIER_ACTIVE_TYPE");
            return `Bot.enableBarrierChanger('${t}');
`;
          }),
        (window.Blockly.Blocks.virtual_token = {
          init() {
            this.jsonInit({
              message0: (0, i.NC)(
                "Virtual Account Token {{ input_virtual_token }}",
                { input_virtual_token: "%1" }
              ),
              args0: [
                { type: "input_value", name: "VIRTUAL_TOKEN", check: null },
              ],
              colour: Blockly.Colours.Base.colour,
              colourSecondary: Blockly.Colours.Base.colourSecondary,
              colourTertiary: Blockly.Colours.Base.colourTertiary,
          ...
          onchange: window.Blockly.Blocks.input_list.onchange,
          getRequiredValueInputs: () => ({ VIRTUAL_TOKEN: null }),
        }),
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.virtual_token =
          () => {}),
        (window.Blockly.Blocks.max_steps = {
          init() {
            this.jsonInit({
              message0: (0, i.NC)(
                "No. of Virtual losses {{ input_max_steps }}",
                { input_max_steps: "%1" }
              ),
              args0: [{ type: "input_value", name: "MAX_STEPS", check: null }],
              colour: Blockly.Colours.Base.colour,
              colourSecondary: Blockly.Colours.Base.colourSecondary,
              colourTertiary: Blockly.Colours.Base.colourTertiary,
              previousStatement: null,
          ...
          onchange: window.Blockly.Blocks.input_list.onchange,
          getRequiredValueInputs: () => ({ MAX_STEPS: null }),
        }),
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.max_steps =
          () => {}),
        (window.Blockly.Blocks.min_trades = {
          init() {
            this.jsonInit({
              message0: (0, i.NC)(
                "No. of Wins on Real Trades {{ input_min_trades }}",
                { input_min_trades: "%1" }
              ),
              args0: [{ type: "input_value", name: "MIN_TRADES", check: null }],
              colour: Blockly.Colours.Base.colour,
              colourSecondary: Blockly.Colours.Base.colourSecondary,
              colourTertiary: Blockly.Colours.Base.colourTertiary,
              previousStatement: null,
          ...
          onchange: window.Blockly.Blocks.input_list.onchange,
          getRequiredValueInputs: () => ({ MIN_TRADES: null }),
        }),
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.min_trades =
          () => {}),
            ...
            args0: [
              {
                ...
                options: (0, R.vc)().lists.BARRIER_OFFSETER_STATUS,
              },
            ],
            colour: window.Blockly.Colours.Special3.colour,
            colourSecondary: window.Blockly.Colours.Special3.colourSecondary,
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.enable_virtual_hook =
          (e) => {
...
`;
    ...
    `);
      let O = (e) => (void 0 === e ? [] : e.map((e) => [e, e])),
        b = () => {
          let e = new Date(new Date().toUTCString()).getUTCMinutes();
          return e >= 0 && e < 7 ? "accountsList2" : "accountsList";
        },
        D = () => {
          if ("undefined" != typeof localStorage)
            return Object.keys(
              JSON.parse(localStorage.getItem(b())) || []
            ).filter((e) => e.startsWith("CR"));
        };
      (window.Blockly.Blocks.enable_copy_demo = {
        ...
        definition: () => ({
          message0: (0, i.NC)(
            "Copy Demo Trades {{ copy_demo_type }} account_id: {{ account_token_types }}",
            { copy_demo_type: "%1", account_token_types: "%2" }
          ),
          args0: [
            {
              type: "field_dropdown",
            ...
            { type: "field_dropdown", name: "SELECT_ACC_ID", options: O(D()) },
          ],
          colour: Blockly.Colours.Special3.colour,
          colourSecondary: Blockly.Colours.Special3.colourSecondary,
          colourTertiary: Blockly.Colours.Special3.colourTertiary,
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.enable_copy_demo =
          (e) => {
            let t = e.getFieldValue("ENABLE_COPY_DEMO"),
              o = JSON.stringify({
                copy_status: t,
                account_id: M(e.getFieldValue("SELECT_ACC_ID")),
              });
...
`;
      ...
      (window.Blockly.Blocks.btnotify = {
        ...
        definition: () => ({
          message0: (0, i.NC)(
            "MkoreanWWN {{ notification_type }} with sound: {{ notification_sound }} {{ input_message }}",
            {
              notification_type: "%1",
              notification_sound: "%2",
              input_message: "%3",
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.btnotify = (
          e
        ) => {
          let t = e.getFieldValue("NOTIFICATION_TYPE"),
            o = e.getFieldValue("NOTIFICATION_SOUND"),
...
`;
        ...
        (window.Blockly.Blocks.lock_blocks_marker = {
          init() {
            this.jsonInit({
              message0: "",
              colour: "#ffffff",
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.lock_blocks_marker =
          () => {});
      var G = o("94576");
          ...
          if (
            (e.type !== window.Blockly.Events.SELECTED || this.isInit
              ? null === window.Blockly.getSelected() &&
                this.isInit &&
                ((this.isInit = !1), (0, G.GZ)("keydown"))
              : ((this.isInit = !0), (0, G.tZ)("keydown")),
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.trade_definition =
          (e) => {
            ...
            let { loginid: o } = t,
              ...
              n = e.getChildByType("trade_definition_contracttype"),
              r = e.getChildByType("trade_definition_candleinterval"),
              s = e.getChildByType("trade_definition_restartonerror"),
              c = e.getChildByType("trade_definition_restartbuysell"),
              u = a.getFieldValue("SYMBOL_LIST"),
              d = l.getFieldValue("TRADETYPE_LIST"),
              p = n.getFieldValue("TYPE_LIST"),
              y = r.getFieldValue("CANDLEINTERVAL_LIST"),
              w = "FALSE" !== s.getFieldValue("RESTARTONERROR"),
              k = "FALSE" !== c.getFieldValue("TIME_MACHINE_ENABLED"),
              B = a.getFieldValue("SUBMARKET_LIST"),
              _ = "TRUE" === a.getFieldValue("MULTI_MARKET"),
              { opposites: h } = (0, S.vc)(),
              m =
                "both" === p
                  ? h[d.toUpperCase()].map((e) => Object.keys(e)[0])
                  : [p],
              v = window.Blockly.JavaScript.javascriptGenerator.statementToCode(
                e,
                "INITIALIZATION"
              ),
              g = window.Blockly.JavaScript.javascriptGenerator.statementToCode(
                e,
                "SUBMARKET"
              );
            return `
    BinaryBotPrivateInit = function BinaryBotPrivateInit() {
        Bot.init('${i}', {
          symbol              : '${u}',
          contractTypes       : ${JSON.stringify(m)},
          candleInterval      : '${y || "FALSE"}',
          shouldRestartOnError: ${w},
          timeMachineEnabled  : ${k},
          multiMarketScanning : ${_ && "random_index" === B},
          submarket           : '${B}',
        });
        ${v.trim()}
    };
...
`;
      ...
      var U = o("10840"),
        F = o("13604");
      let P = () => {
        window.dispatchEvent(new CustomEvent("openVirtualHookModal"));
      };
      if (!window.__VH_FIELDS_REGISTERED__) {
        window.__VH_FIELDS_REGISTERED__ = !0;
        class e extends window.Blockly.Field {
          static fromJson(t) {
            return new e(null == t ? void 0 : t.text);
          }
          initView() {
            this.createBorderRect_(),
              ...
              this.borderRect_ &&
                ...
                this.borderRect_.setAttribute("fill", "#ffeb3b"),
                this.borderRect_.setAttribute("stroke", "#fff"),
                this.borderRect_.setAttribute("stroke-width", "2"),
                (this.borderRect_.style.filter =
                  "drop-shadow(0 2px 6px rgba(255,235,59,0.6))")),
              this.textElement_ &&
                ((this.textElement_.style.fill = "#ff0000"),
                (this.textElement_.style.fontWeight = "700"),
                (this.textElement_.style.fontSize = "12px"),
                (this.textElement_.style.textShadow =
          ...
          updateSize_() {
            let e =
              (this.textElement_
                ? window.Blockly.utils.dom.getTextWidth(this.textElement_)
                : 0) + 20;
            this.borderRect_ &&
              (this.borderRect_.setAttribute("width", e),
              this.borderRect_.setAttribute("height", 26),
        ...
        window.Blockly.fieldRegistry.register("field_vh_settings_btn", e);
      }
      (window.Blockly.Blocks.trade_definition_market = {
        init() {
          this.jsonInit({
            ...
            message1: (0, i.NC)(
              "Alternate markets (Continuous Indices only): {{ checkbox }} every {{ runs }} run(s)",
              { checkbox: "%1", runs: "%2" }
            ),
            args1: [
              {
            ...
            message2: (0, i.NC)(
              "Scan all volatility markets simultaneously: %1",
              { interpolation: "%1" }
            ),
            args2: [
              {
            ...
            message3: (0, i.NC)("Virtual Hook: %1 %2", {
              interpolation: "%1 %2",
            }),
            args3: [
              {
            ...
            this.setMovable(!1),
            this.setDeletable(!1);
          let e = this.getField("VH_SETTINGS_BTN");
          e &&
            (e.setTooltip((0, i.NC)("Click to open Virtual Hook settings")),
            e.showEditor_,
            (e.showEditor_ = function () {
              P();
            }));
        },
        customContextMenu(e) {
        ...
        onchange(e) {
          ...
          let { active_symbols: o } =
            (null === F.Z || void 0 === F.Z ? void 0 : F.Z.instance) ?? {};
          if (!o) return;
          let i = this.getField("MARKET_LIST"),
            a = this.getField("SUBMARKET_LIST"),
            l = this.getField("SYMBOL_LIST"),
            n = this.getField("ALTERNATE_MARKETS"),
            r = this.getField("ALTERNATE_EVERY"),
            s = this.getField("MULTI_MARKET"),
            c = i.getValue(),
            u = a.getValue(),
            d = l.getValue();
          if (n) {
            let e = "random_index" === u;
            n.setVisible(e),
              null == r || r.setVisible(e),
              null == s || s.setVisible(e),
              !e && (n.setValue("FALSE"), null == s || s.setValue("FALSE"));
          }
          let p = this.getField("VH_ENABLED");
          if (
            (this.getField("VH_SETTINGS_BTN"),
            e.type === window.Blockly.Events.BLOCK_CHANGE &&
              "VH_ENABLED" === e.name)
          ) {
            let e = (null == p ? void 0 : p.getValue()) === "TRUE";
            (0, U.as)(e, {
              token: U.B2,
              authorize: e,
              emit_event: !0,
          ...
          let y = o.getMarketDropdownOptions(),
            w = () => {
              null == i ||
                i.updateOptions(y, {
                  default_value: c,
          ...
          e.ids.includes(this.id)
            ...
            : e.type === window.Blockly.Events.BLOCK_CHANGE &&
              e.blockId === this.id
            ? "MARKET_LIST" === e.name
              ? a.updateOptions(o.getSubmarketDropdownOptions(c), {
                  default_value: u,
                  should_pretend_empty: !0,
                  event_group: e.group,
                })
              : "SUBMARKET_LIST" === e.name &&
                l.updateOptions(o.getSymbolDropdownOptions(u), {
                  default_value: d,
                  should_pretend_empty: !0,
                  event_group: e.group,
                })
        ...
        mutationToDom() {
          let e = document.createElement("mutation"),
            t = this.getField("VH_ENABLED"),
            o = (null == t ? void 0 : t.getValue()) === "TRUE";
          return (
            e.setAttribute("vh_enabled", o.toString()),
            e.setAttribute(
              "vh_max_steps",
              (S.GL.vh_variables.max_steps || 1).toString()
            ),
            e.setAttribute(
              "vh_min_trades",
              (S.GL.vh_variables.min_trades || 1).toString()
            ),
            e.setAttribute(
              "vh_stake",
              (S.GL.vh_variables.stake || 0.35).toString()
            ),
            e
          );
        },
        domToMutation(e) {
          if (!e) return;
          let t = "true" === e.getAttribute("vh_enabled"),
            o = this.getField("VH_ENABLED");
          o && o.setValue(t ? "TRUE" : "FALSE");
          let i = parseInt(e.getAttribute("vh_max_steps")) || 1,
            a = parseInt(e.getAttribute("vh_min_trades")) || 1,
            l = parseFloat(e.getAttribute("vh_stake")) || 0.35;
          (0, U.as)(t, {
            token: U.B2,
            max_steps: i,
            min_trades: a,
            ...
            window.dispatchEvent(
              new CustomEvent("vhSettingsLoaded", {
                detail: { enabled: t, max_steps: i, min_trades: a, stake: l },
              })
            );
        },
      }),
          ...
          onchange(e) {
            ...
            if (
              ...
              let o = e.newValue,
                ...
                l = [],
                n = (0, f.M)("both", o);
              n.length > 1 && l.push([(0, i.NC)("Both"), "both"]),
                l.push(...n),
                0 === l.length &&
                  l.push(...(0, S.vc)().NOT_AVAILABLE_DROPDOWN_OPTIONS),
                a.updateOptions(l, {
                  event_group: e.group,
              ...
              args0: [
                {
                  type: "field_dropdown",
                  name: "CANDLEINTERVAL_LIST",
                  options: (0, S.vc)().candleIntervals.slice(1),
                },
              ],
              colour: window.Blockly.Colours.Base.colour,
              colourSecondary: window.Blockly.Colours.Base.colourSecondary,
      ...
      (window.Blockly.Blocks.trade_definition_tradeoptions = {
        ...
        definition() {
          ...
          return {
            ...
            message2: (0, i.NC)("Trade each tick: {{ checkbox }}", {
              checkbox: "%1",
            }),
            args0: [
              {
            ...
            args1: [
              {
                type: "field_label",
                name: "CURRENCY_LIST",
                text: (0, j.O$T)((0, S.vc)().lists.CURRENCY[0]),
              },
            ...
            for (let o = 0; o < e.values.length; o++) {
              ...
              if (l) l.fieldRow[0].setText(a);
                ...
                l = this.appendValueInput(t[o])
                  ...
                  .appendField(
                    new window.Blockly.FieldDropdown((0, S.vc)().BARRIER_TYPES),
                    `${t[o]}TYPE_LIST`
                  );
        ...
        updateBarrierInputs(e, t) {
          ...
          o.getBarriers(
            ...
            for (let n = 0; n < o.values.length; n++) {
              let r = this.getField(`${l[n]}TYPE_LIST`),
                { ABSOLUTE_BARRIER_DROPDOWN_OPTION: s } = (0, S.vc)(),
                c = e ? i[n][1] : r.getValue();
              if ("d" === this.selected_duration)
                r.updateOptions(s, { default_value: "absolute" });
              else if (o.allow_both_types || o.allow_absolute_type) {
                let e = [].concat(i, s);
                r.updateOptions(e, { default_value: c });
              } else r.updateOptions(i, { default_value: c });
              let { connection: u } = this.getInput(l[n]);
              if (t && u) {
                let e = u.targetBlock();
                if (e && e.isShadow()) {
                  let t = !1 !== o.values[n] ? o.values[n] : "";
                  (0, a.$9)(() => {
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.trade_definition_tradeoptions =
          (e) => {
            ...
            let a =
              ...
              { currency: l } = L.Z.instance.client,
        ...
        Bot.start({
            ...
            trade_each_tick      : ${
              "FALSE" !== e.getFieldValue("TRADE_EACH_TICK")
            },
            basis              : '${
              "trade_definition_tradeoptions" === e.type ? "stake" : "payout"
            }',
        });
        BinaryBotPrivateTradeEachTick = ${
          "FALSE" !== e.getFieldValue("TRADE_EACH_TICK")
        };
              ...
              (0, a.$9)(() => {
                (0, a.UR)(!1, () => {
                  ...
                  let l = o.getInput("DURATION"),
                    n = this.workspace.newBlock("math_number_positive");
                  n.setShadow(!0),
                    n.outputConnection.connect(l.connection),
                    n.initSvg(),
                    n.renderEfficiently();
                  let r = o.getInput("AMOUNT"),
                    s = this.workspace.newBlock("math_number_positive");
                  s.setShadow(!0),
                    s.setFieldValue(1, "NUM"),
                    s.outputConnection.connect(r.connection),
                    s.initSvg(),
                    s.renderEfficiently(),
                    this.dispose(),
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.trade_definition_multiplier =
          (e) => {
            ...
            let i =
              ...
              { currency: a } = L.Z.instance.client,
              { setContractUpdateConfig: l } = L.Z.instance,
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.trade_definition_accumulator =
          (e) => {
            ...
            let o =
              ...
              { currency: i } = L.Z.instance.client,
              { setContractUpdateConfig: a } = L.Z.instance,
...
`;
        ...
        (window.Blockly.JavaScript.javascriptGenerator.forBlock.text_append = (
          ...
          var t;
          let o = window.Blockly.JavaScript.variableDB_.getName(
              e.getFieldValue("VAR"),
              window.Blockly.Variables.CATEGORY_NAME
            ),
            i =
