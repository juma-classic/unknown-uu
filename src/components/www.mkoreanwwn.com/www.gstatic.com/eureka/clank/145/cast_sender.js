(function () {
  ...
  var da = g,
    ...
    fa = function (a) {
      ...
      if (typeof a.length == "number") return { next: ea(a) };
...
*/
  var q = this || self,
    ...
    w = function (a, b) {
      a = a.split(".");
      for (var c = q, d; a.length && (d = a.shift()); )
        a.length || b === void 0
...
*/
  ...
  var xa = Array.prototype.forEach
    ? function (a, b) {
  ...
  J.prototype.delete = function (a) {
    return L(this.i, a)
      ? (delete this.i[a],
        --this.size,
        this.l++,
        this.g.length > 2 * this.size && K(this),
        !0)
      : !1;
  };
  var K = function (a) {
  ...
  var Sa = function () {
    ...
    Ua = function (a, b) {
      ...
      if (a.playerState == chrome.cast.media.B.IDLE && a.loadingItemId == null)
        ...
        var h = a.items;
        c = {};
        if (h) for (var l = 0; l < h.length; l++) c[h[l].itemId] = l;
        b = fa(b.items);
        for (h = b.next(); !h.done; h = b.next()) {
          ...
          if (!h.media) {
            ...
            m && m.media
              ? (h.media = m.media)
              : l == a.currentItemId && a.media && (h.media = a.media);
          }
          l = e;
          m = l.push;
          var p = void 0,
  ...
  U.prototype.initialize = function (a, b) {
    ...
    this.g = a;
    a.invisibleSender ||
      ((a = new PresentationRequest(W(this))),
      ...
      (this.ia = (q.navigator || null).presentation.defaultRequest = a),
  ...
  var W = function (a, b) {
    ...
    var e = b.dialRequest;
    e &&
      ((c = e.appName), (d = e.launchParameter) && !d.match(db) && (d = $a(d)));
    var h = [];
    h.push({ appId: b.appId, capabilities: b.capabilities });
    b ||
      xa(a.g.additionalSessionRequests, function (l) {
        h.push({ appId: l.appId, capabilities: l.capabilities });
      });
    return Ra(
      new Qa(
        h,
  ...
  f.setReceiverVolume = function (a, b, c, d) {
    ...
    V(
      ...
      new N(this.i, c, d, chrome.cast.timeout.sendCustomMessage)
    );
  };
  f.getDialAppInfo = function (a, b) {
    V(
      ...
      new N(this.i, a, b, chrome.cast.timeout.sendCustomMessage)
    );
  };
  f.ca = function (a) {
    var b = this;
    new PresentationRequest(W(this)).reconnect(chrome.cast.cb + a).then(
      function (c) {
        X(b, c);
      },
      function () {}
  ...
  f.leaveSession = function (a, b, c) {
    V(
      ...
      new N(this.i, b, c, chrome.cast.timeout.leaveSession)
    );
  };
  f.kc = function (a, b, c) {
    V(
      ...
      new N(this.i, b, c, chrome.cast.timeout.sendCustomMessage)
    );
  };
  ...
  U.prototype.onMessage = function (a) {
    ...
    if ((b = Ma(this.S, a.sequenceNumber)))
